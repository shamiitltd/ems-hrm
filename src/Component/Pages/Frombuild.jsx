        ...
        <div className="card h-100 border rounded-lg">
          <div className='bg-light mx-2 rounded'>
            <div className='rounded hp-div justify-content-left py-2 w-75 my-3 mx-3 d-flex flex-column flex-md-row'>
              ...
              <button className='btn btn-light mx-1 mb-2 mb-md-0'>Score Card</button>
            </div>
          </div>
              ...
              <form className='justify-content-between'>
                <div className="form-row d-flex">
                  <div className="form-group flex-grow-1 col-md-6">
                    ...
                    <input type="text" className="form-control" placeholder="Your full name"  style={{ width: '70%' }} />
                  </div>
                  <div className="form-group col-md-6" style={{ marginLeft: '10px' }}>
                    <label>Email:</label>
                    <input type="email" className="form-control" placeholder="Your email" style={{ width: '70%' }} />
                  </div>
                </div>
                <div className="form-group mt-2 col-md-6">
                  <label>Phone:</label>
                  <input type="tel" className="form-control" placeholder="Your phone number" style={{ width: '70%' }} />
                </div>
                <div className="form-group mt-2">
                  <label>Portfolio:</label>
                  <textarea className="form-control" placeholder="Drag and drop" disabled style={{ width: '85%' }} />
                </div>
                ...
                <div className="form-row mt-3 d-flex">
                  ...
                  <div className="form-group col-md-6">
                    <label>Country:</label>
                    <input type="text" className="form-control" placeholder="Select country" style={{ width: '70%' }} />
                  </div>
                </div>
        ...
        <div className="card h-100 border rounded-lg">
          ...
          <div className='card-body mt-3 bg-light'>
            <div className="form-group">
              <input type="text" className="form-control mb-3" placeholder="Add Group Field" />
            </div>
            <div className='border py-3 mx-3'>
              ...
              <div className="d-flex mx-3 my-3 flex-wrap">
                <div className="d-flex me-3 mb-2 w-100">
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">T Paragraph</button>
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Form Field</button>
                </div>
                <div className="d-flex me-3 mb-2 w-100">
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Text Area</button>
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Radio Button</button>
                </div>
                <div className="d-flex me-3 mb-2 w-100">
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Checkbox</button>
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Date Picker</button>
                </div>
                <div className="d-flex me-3 mb-2 w-100">
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Dropdown</button>
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Attachment</button>
                </div>
                <div className="d-flex me-3 mb-2 w-100">
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">Hyperlink</button>
                  <button className="btn btn-outline-secondary m-1 flex-grow-1">List Item</button>
                </div>
              </div>
