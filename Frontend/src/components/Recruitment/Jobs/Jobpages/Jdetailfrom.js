          ...
          <div className="card h-100 border rounded-lg">
            ...
            <div className="card-body mt-3 bg-light">
              ...
              <div className="mt-3 mx-3 border border-secondary p-3">
                ...
                <div>
                  <p>
                    We are hiring on behalf of a fast-growing startup. They
                    empower restaurants to thrive in the competitive delivery
                    marketplace. Their technology enables restaurants to recover
                    80% of disputed money on platforms like DoorDash, UberEats,
                    and Grubhub with a single click, boost profits by 25%,
                    manage online ads and promotions through one interface, and
                    respond to all customer reviews using AI.
                  </p>
                </div>
                <div>
                  ...
                  <ul>
                    <li>
                      Front-End Development: Assist in building and maintaining
                      responsive web interfaces using HTML, CSS, and ReactJS
                    </li>{" "}
                    <li>
                      Back-End Development: Contribute to server-side
                      development using NodeJS, including creating RESTful APIs
                      and
                    </li>
                    <li>
                      Consult with end user to prototype, refine, test, and
                      debug programs to meet needs
                    </li>
                    <li>
                      {" "}
                      backend developers, and other stakeholders to deliver
                    ...
                    <li>
                      Participate in software design meetings and analyze user
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      {" "}
                      Proficiency in HTML, CSS, JavaScript, and responsive
                      design principles.
                    </li>
                    <li>
                      {" "}
                      Strong communication and collaboration abilities, with a
                      focus on teamwork.
                    </li>
                    <li>
