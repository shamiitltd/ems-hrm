        ...
        <div className="col-lg-6 mb-3">
          <div className="card h-100 border rounded-lg">
            ...
            <div className="card-body mt-3 bg-light px-4 py-3">
              ...
              {[
                {
                  title: "Screening Schedule Change",
                  date: "March 20, 2024",
                  time: "3:00 PM",
                  description:
                    "Due to an unexpected event, the screening end date has been changed from March 31 to March 20.",
                },
                {
                  title: "Interview Schedule Change",
                  date: "April 5, 2024",
                  time: "10:00 AM",
                  description:
                    "The interview schedule has been adjusted from April 7 to April 5.",
                },
                {
                  title: "Final Round Schedule Change",
                  date: "April 10, 2024",
                  time: "1:00 PM",
                  description:
                    "The final round has been rescheduled from April 12 to April 10.",
                },
                {
                  title: "Onboarding Schedule Change",
                  date: "April 15, 2024",
                  time: "9:00 AM",
                  description:
                    "The onboarding session has been moved from April 20 to April 15.",
                },
                {
                  ...
                  time: "2:00 PM",
                  description:
                    "The training session has been shifted from April 21 to April 18.",
                },
              ].map((change, index) => (
                <div key={index}>
                  <h5>{change.title}</h5>
                  ...
                  {index < 4 && <hr />}{" "}
                  {/* Add hr only between items, not after the last one */}
                </div>
              ))}
            </div>
          </div>
